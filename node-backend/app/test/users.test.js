...
describe("test cases for users", function () {
  ...
  it("/users/me get method should give status 200", function (done) {
    request(app)
      ...
      .end(function (err, res) {
        res.status.should.equal(200);
        res.body.data.id.should.equal(userId);
  ...
  it("/users/me put method should give status 200", function (done) {
    request(app)
      ...
      .end(function (err, res) {
        res.status.should.equal(200);
        res.body.data.id.should.equal(userId);
        res.body.data.first_name.should.equal("xyz");
        res.body.data.last_name.should.equal("abc");
        res.body.data.display_name.should.equal("pqr");
        should(res.body.data).be.a.Object();
        done();
      });
  });
  it("/users/:id put method should give status 200", function (done) {
    request(app)
      ...
      .end(function (err, res) {
        res.status.should.equal(200);
        res.body.data.id.should.equal(userId);
        res.body.data.role_id.should.equal(3);
        should(res.body.data).be.a.Object();
        done();
      });
  });
